# sm64super
Fork of [sm64pc/sm64ex](https://github.com/sm64pc/sm64ex) with Vulkan support. 
...
## Building
For building instructions, please refer to the [wiki](https://github.com/SirKnightTG/sm64super/wiki).
